...
function! FernInit() abort
  ...
  nmap <buffer> l <Plug>(fern-action-reload)
  "nmap <buffer> k <Plug>(fern-action-mark-toggle)
  nmap <buffer> o <Plug>(fern-my-open-expand-collapse)
  nmap <buffer> b <Plug>(fern-action-open:split)
  nmap <buffer> v <Plug>(fern-action-open:vsplit)
  nmap <buffer> u <Plug>(fern-action-open:system)
  nmap <buffer><nowait> < <Plug>(fern-action-leave)
  nmap <buffer><nowait> > <Plug>(fern-action-enter)
  
  " Preview files keeping the coursor on the Fern buffer
  nmap <buffer> <tab> <Plug>(fern-my-open-expand-collapse)<C-w>h
endfunction
